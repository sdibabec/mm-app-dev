...
<div class="row">
    ...
    <form id="datos" name="datos" action="<?=$_SERVER['REQUEST_URI']?>" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="eAccion" id="eAccion">
           ...
           <div class="form-group">
              <label>Tipo</label>
               <select id="eCodTipoProducto" name="eCodTipoProducto">
               <option value="">Seleccione..</option>
                   <?
                    $select = "SELECT * FROM CatTiposProductos ORDER BY eCodTipoProducto ASC";
                    $rsTiposProductos = mysql_query($select);
          while($rTipoProducto = mysql_fetch_array($rsTiposProductos))
          { ?> 
                   <option value="<?=$rTipoProducto{'eCodTipoProducto'};?>" <?=($rTipoProducto{'eCodTipoProducto'}==$rPublicacion{'eCodTipoProducto'}) ? 'selected="selected"' : ''?>><?=$rTipoProducto{'tNombre'};?></option>
                   <? } ?>
               </select>
           </div>
           ...
           <div class="form-group">
            ...
            <div class="form-group">
              <label>Enlace </label>
              <input type="text" class="form-control" name="tEnlace" id="tEnlace" placeholder="Enlace" value="<?=($rPublicacion{'tEnlace'})?>" >
