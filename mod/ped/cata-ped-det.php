                                    ...
                                    <table class="table table-responsive table-borderless table-top-campaign" id="table" width="100%">
                                        ...
                                        <tbody>
											...
											$select = "	SELECT DISTINCT
                                                        ...
                                                        INNER JOIN CatProductos cp ON cp.eCodProducto=rpp.eCodProducto
                                                        WHERE rpp.eCodPedido = ".$_GET['v1'];
											...
											<tr id="paq<?=$i?>">
												...
												<td>
                                                    <a href="http://fettmerch.com/pedidos/<?=$rPublicacion{'tIdentificador'};?>/">Ir al directorio</a>
                                                </td>
                                            </tr>
											<? } ?>
                                        </tbody>
