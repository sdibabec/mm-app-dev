...
$select = "	SELECT 
                                                    ...
                                                    ($_SESSION['sessionAdmin']['eCodPerfil']==4 ? "" : "");
//echo $select;
        ...
        <input type="hidden" name="eAccion" id="eAccion">
          ...
          <div class="form-group">
           ...
           <div class="form-group">
              ...
              <div class="form-control" name="tEstatusPago2" id="tEstatusPago2" ><b><?=$rPublicacion{'tEstatusPago'};?></b></div>
           </div>
           ...
           <div class="form-group">
              ...
              <table width="100%" id="tblModulos" cellspacing="1" class="table-striped">
                  <tr>
                    <td>Nombre</td>
                    <td>Fecha</td>
                    <td>Horas</td>
              ...
              <?
                ...
                <tr id="fila<?=$i;?>">
                    ...
                    <td align="right">
                        <? if($rModulo{'tEmbed'} && $rPublicacion{'eCodEstatusPago'}==9 && ($_SESSION['sessionAdmin']['eCodUsuario']==$rPublicacion{'eCodUsuario'})) { ?>
                        <a href="<?=$rModulo{'tEmbed'};?>" class="btn btn-info" target="_blank">Ir a la transmisi&oacute;n</a>
                        <? } ?>
                    </td>
                  </tr>
                <? $i++; ?>
