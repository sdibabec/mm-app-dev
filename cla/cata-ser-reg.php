...
/*Preparacion de variables*/
    ...
    $eCodServicio   =   $data->eCodServicio ? (int)$data->eCodServicio : false;
...
if(!sizeof($errores))
{
        ...
        if(!$rs)
        {
            $errores[] = 'Error de insercion/actualizacion del servicio '.mysql_error();
        }


if(!sizeof($errores))
{
    $tDescripcion = "Se ha insertado/actualizado el servicio ".sprintf("%07d",$eCodServicio);
